...
export function RouteNotFound() {
    ...
    return (
        <div className={styles.errorpage}>
            ...
            <h1 className={styles.heading}>The page you're looking for <br /> seems to be missing</h1>
            <p className={styles.linkSection}>Maybe you'll find what you're looking for here:</p>
